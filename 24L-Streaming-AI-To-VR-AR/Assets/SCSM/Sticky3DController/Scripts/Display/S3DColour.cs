...
namespace scsmmedia
{
    ...
    public struct S3DColour
    {
        ...
        #region Constructors
        public S3DColour(byte red, byte green, byte blue, byte alpha)
        {
            r = red;
            g = green;
            b = blue;
        ...
        public S3DColour(float red, float green, float blue, float alpha)
        {
        ...
        public S3DColour(Color32 color)
        {
            r = color.r;
            g = color.g;
            b = color.b;
        ...
        public static implicit operator S3DColour(Color c)
        {
            return new S3DColour(c);
        }

        public static implicit operator S3DColour(Color32 c)
        {
            return new S3DColour(c);
        }
        #endregion
