...
{
    /// <summary>
    /// Class containing data for a Sticky Display's guage or visual measuring device.
    /// </summary>
    [System.Serializable]
    public class S3DDisplayGauge
    {
        #region Enumerations
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeText(..)
        /// </summary>
        ...
        /// <summary>
        /// Show (or hide) the gauge. At runtime use stickyDisplayModule.ShowDisplayGauge() or HideDisplayGauge().
        /// </summary>
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeOffset(..)
        /// </summary>
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeSize(..)
        /// </summary>
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeValueAffectsColour(..)
        /// </summary>
        public bool isColourAffectByValue;

        /// <summary>
        /// Colour of the gauge foreground.
        /// At runtime call stickyDisplayModule.SetDisplayGaugeForegroundColour(..)
        /// </summary>
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeBackgroundColour(..)
        /// </summary>
        ...
        /// At runtime call stickyDisplayModule.SetDisplayGaugeTextColour(..).
        /// </summary>
        public Color textColour;

        /// <summary>
        /// The position of the text within the diplay gauge panel.
        /// At runtime call stickyDisplayModule.SetDisplayGaugeTextAlignment(..)
        /// </summary>
        public TextAnchor textAlignment;

        /// <summary>
        /// The rotation of the text within the display gauge panel.
        /// At runtime call stickyDisplayModule.SetDisplayGaugeTextDirection(..)
        /// </summary>
        public DGTextDirection textDirection;

        /// <summary>
        /// The style of the text with the display gauge panel.
        /// At runtime call stickyDisplayGaugeTextFontStyle(..)
        /// </summary>
        ...
        /// to fill the panel?
        /// At runtime call stickyDisplayModule.SetDisplayGaugeTextFontSize(..)
        /// </summary>
        ...
        /// </summary>
        [System.NonSerialized] internal S3DColour baseForegroundColour;
        ...
        public S3DDisplayGauge(S3DDisplayGauge displayGauge)
        {
